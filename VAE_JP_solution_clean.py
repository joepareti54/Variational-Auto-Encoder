...
num_channels = 1  # MNIST --> grayscale, so 1 channel
...
# Custom function for sampling in the latent space
def sampling(z_args)
    z_mu, z_sigma = z_args
...
# Use the sampling function to create the z tensor
...
vae.fit(x_train, x_train, epochs=10, batch_size=32, validation_split=0.2
